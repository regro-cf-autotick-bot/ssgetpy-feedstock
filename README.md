...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ssgetpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14073&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ssgetpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ssgetpy` can be installed with:

```
conda install ssgetpy
```

It is possible to list all of the versions of `ssgetpy` available on your platform with:
